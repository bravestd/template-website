...
const fallbackDownloads = 0; // num of downloads showed if api down.
const fallbackCommits = 0; // num of commits showed if api down.
...
const Skills: React.FC<Props> = ({ commits, downloads }) => {
  ...
  return (
    <div ref={refContainer} className="bg-black text-white">
      <div className="min-h-screen max-w-5xl mx-auto p-10 lg:px-20 py-24 md:py-28 lg:py-36 flex flex-col justify-center items-center text-4xl md:text-6xl lg:text-7xl tracking-tight font-semibold">
